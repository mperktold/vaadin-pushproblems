...
import it.prodata.views.about.AboutView;
import it.prodata.views.helloworld.HelloWorldView;
...
public class MainView extends AppLayout {
	...
	private static Component createDrawerContent(Tabs menu) {
		...
		logoLayout.add(new Image("images/logo.png", "PushProblems logo"));
		logoLayout.add(new H1("PushProblems"));
	...
	private static boolean hasLink(Component tab, String currentRoute) {
